...
// 视觉锚定:   仓库根 assets/characters/ 下 41 张立绘
...
export const characters: Character[] = [
  // ========== 主角组 ==========
  {
    ...
    colorVar: 'var(--c-pink)',
    power: '光魔法 · 变出小花和小光球',
    bio: '故事的第一人称讲述者,4 岁妹妹。金色蓬松短发扎双丸子头(白花球发卡),琥珀红大眼睛。穿浅绿色斗篷配米黄色连衣裙,喜欢说"我来我来!"和"哇——"。口头禅"嘿嘿",喜欢和姐姐跳舞画画。她有一只全黑的玩偶猫叫黑黑,会"躲猫猫"魔法。第十一集,三岁的新同学点点拼到她旁边做同桌,她第一次当起了"姐姐"——忍住不抢著帮忙,看点点自己放碗、自己摘甜甜圈。',
  ...
  },
  {
    ...
    bio: '5 岁初级生,第十四集登场的新同学——全班第一位男同学,安雨的老乡。蓝蓝的长头发,头顶两只小龙角,穿蓝白色长袍,身后拖着长长的龙尾巴(尾巴尖是蓝紫色的,像一小片傍晚的海)。从很远很远的东海龙宫来:跟信一起出发,自己游过来的——"信比我快。"说话轻轻的,先鞠躬再说话,尾音带一个软软的"哦";安静,但会冷不丁开玩笑("我会告诉老师的。……开玩笑的哦。"),他的影子比他还有礼貌,会先鞠躬。他的海浪魔杖蓝白色的、弯弯的,像一小截冻住的海浪,顶上浅蓝色珠子——从东海起就一直醒着,是陪他游远路的旅伴;和安雨的龙珠魔杖一见面,两颗珠子就一起亮了:"魔杖,认出了老乡。"他的娃娃叫小绿豆(浅蓝头发、头顶银色小龙、龙鳞小裙),在东海就醒了,从来没有睡过。第一天夜里,他嘴上说"龙走到哪里,海就在哪里",可是海有一点点远——安雨陪他在走廊坐了一整夜;第二天清晨,安雨的小红豆终于敢醒了。敖丙说,安雨"比龙族的长老,说得还好哦"。',
