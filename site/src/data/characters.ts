...
export const characters: Character[] = [
  ...
  // ========== 老师组 ==========
  {
    ...
    colorVar: 'var(--c-cream)',
    power: '魔法入门课教学',
    bio: '学院班主任。粉色长发扎成高高马尾,表情柔和,笑起来很温柔。穿紫白色长袍,手持教鞭和魔法书。最爱给小甜心改作业(因为作业本上总有饼干渣)。第十五集揭晓:新同学小豆包是她的女儿——"你看。我们,是一个蒸笼里出来的哦。"女儿上学第一天拜托她保密,她答应了,还故意装作什么都不知道;夜里,她会去宿舍给女儿盖被子。名字来源:女儿小橘子喜欢的豆包 App。',
